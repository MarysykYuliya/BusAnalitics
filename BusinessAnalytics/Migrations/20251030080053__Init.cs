        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RegistrationCode = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BusinessAccounts_AspNetUsers_OwnerId",
                        column: x => x.OwnerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ExpenseCategories_BusinessAccounts_BusinessAccountId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductCategories_BusinessAccounts_BusinessAccountId",
                        column: x => x.BusinessAccountId,
                        principalTable: "BusinessAccounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Products_BusinessAccounts_BusinessAccountId",
                        column: x => x.BusinessAccountId,
                        principalTable: "BusinessAccounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BusinessAccounts_OwnerId",
                table: "BusinessAccounts",
                column: "OwnerId");

            migrationBuilder.CreateIndex(
                name: "IX_ExpenseCategories_BusinessAccountId",
                table: "ExpenseCategories",
                column: "BusinessAccountId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductCategories_BusinessAccountId_Name",
                table: "ProductCategories",
                columns: new[] { "BusinessAccountId", "Name" });

            migrationBuilder.CreateIndex(
                name: "IX_Products_BusinessAccountId_Name",
                table: "Products",
                columns: new[] { "BusinessAccountId", "Name" });
